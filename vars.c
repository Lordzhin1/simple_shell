...
/**
 * is_chain - test if new character in buffer is a chain delimeter
 * @info: the parameter struct
 * @buf: the char buffer
 * @p: the address of new position in buffer
 *
 ...
 * @p: address of new position in buffer
 * @i: commencing position in buffer
 * @len: buffer length
 *
 * Return: Void
 */
